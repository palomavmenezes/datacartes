...
<header>
    ...
    <div class="container-fluid menu-top">
      ...
      <nav id="navbar" class="navbar navbar-expand-md justify-content-center menu-top-bar">
      	<div class="row menu">
		      ...
		      <a href="<?php echo home_url(); ?>">  <img class="entire" src="<?php echo get_template_directory_uri(); ?>/img/logo.png" width="150px"> </a></li>
             <ul> <li><?php wp_nav_menu( array( 'theme_location' => 'entire' ) ); ?></li>
		      	</ul>
		      </div>
        </div>
      </nav>
    ...
    <img class="logo-mobile-menu" src="<?php echo get_template_directory_uri(); ?>/img/logo.png">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent1">
    ...
    <ul class="navbar-nav">
     <!-- <li class="nav-item active fas fa-bars fa-1x">
      ...
      <li><?php wp_nav_menu( array( 'theme_location' => 'entire' ) ); ?></a></li>
    </ul>
    <!-- Links -->
